...
<div>
    ...
    <div class="span4" onTablet="span4" onDesktop="span4">
        ...
        <div class="form-group">
            ...
            <input disabled type="number" step="any" name="isbn" id="isbn" placeholder="" 
            @if ($con)
        ...
        <div class="form-group">
            ...
            <input disabled text="number" name="title" id="title" placeholder="" @if ($book)
                value="{{ $book->name }}" @else value="" @endif>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"  name="batch" id="batch" placeholder="" @if ($book)
                value="{{ $book->edition }}" @else value="" @endif>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number"  name="balance" id="balance" placeholder="" @if ($book)
                value="{{ $book->amount }}" @else value="" @endif>
        </div>
    ...
    <div class="span5" onTablet="span5" onDesktop="span5">
        <div class="form-group">
            ...
            <input type="number" name="copy" id="copy" placeholder="Enter Number of Sell Copy" value="">
        </div>
