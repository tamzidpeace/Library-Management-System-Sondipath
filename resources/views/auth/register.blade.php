                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="from-group row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-md-6 dropdown">
                                <button class=" from-control btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  Select
                                </button>
